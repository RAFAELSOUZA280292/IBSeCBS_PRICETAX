...
def check_password() -> bool:
    ...
    # =========================================================
    # ABORDAGEM: overlay position:fixed cobre 100vw x 100vh
    # O Streamlit renderiza os widgets abaixo do overlay HTML,
    # mas os inputs/botões ficam visíveis via z-index.
    # =========================================================

    # Montar logo em base64
    ...
    try:
        ...
        logo_html = f'<img src="data:image/png;base64,{_logo_data}" alt="PRICETAX" style="max-width:180px;height:auto;filter:drop-shadow(0 4px 16px rgba(255,221,0,0.4));">'
    ...
    if st.session_state.get("password_correct") is False:
        ...
        if access_denied_msg:
            error_html = f'<div style="background:rgba(239,68,68,0.12);border-left:3px solid #EF4444;border-radius:6px;padding:0.75rem 1rem;color:#EF4444;font-size:0.8rem;font-family:Poppins,sans-serif;margin-bottom:0.75rem;">{access_denied_msg}</div>'
        else:
            attempts = st.session_state.get("login_attempts", 0)
            error_html = f'<div style="background:rgba(239,68,68,0.12);border-left:3px solid #EF4444;border-radius:6px;padding:0.75rem 1rem;color:#EF4444;font-size:0.8rem;font-family:Poppins,sans-serif;margin-bottom:0.75rem;">Usuário ou senha incorretos. Tentativa {attempts}.</div>'

    st.markdown(f"""
    <style>
    @import url('https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;500;600;700;800&display=swap');

    /* Ocultar tudo do Streamlit exceto os widgets de input */
    ...
    /* Esconder o container padrão do Streamlit */
    .block-container {{
        padding: 0 !important;
        margin: 0 !important;
    ...
    /* Overlay que cobre toda a viewport */
    .login-overlay {{
        position: fixed;
        top: 0;
        left: 0;
    ...
    .stTextInput > div > div > input:focus {{
        ...
        box-shadow: 0 0 0 2px rgba(255,221,0,0.15) !important;
    ...
    .stButton > button {{
        ...
        font-family: 'Poppins', sans-serif !important;
        box-shadow: 0 6px 20px rgba(255,221,0,0.35) !important;
        transition: all 0.2s ease !important;
    }}
    .stButton > button:hover {{
        background: #E6C700 !important;
        box-shadow: 0 8px 28px rgba(255,221,0,0.5) !important;
    ...
    <div class="login-overlay">
      ...
      <div class="login-left">
        ...
        <div class="login-headline">
          Inteligência Tributária<br>para a <span>Reforma</span>
        </div>
        <div class="login-subtitle">
          Soluções para a transição inteligente na Reforma Tributária.<br>
      ...
      <!-- COLUNA DIREITA: título e subtítulo apenas; inputs via Streamlit abaixo -->
    ...
    # Inputs e botão do Streamlit ficam abaixo do overlay, mas o CSS os posiciona
    # dentro da coluna direita via z-index e posicionamento relativo ao stApp.
    # Usamos um container vazio à esquerda para empurrar os widgets para a direita.
