        ...
        with open(data_file, 'a', newline='', encoding='utf-8') as f:
            ...
            for item in itens:
                ...
                row = {
                    ...
                    'emitente_razao': emitente.get('razao_social', ''),
                    'emitente_uf': emitente.get('uf', ''),
                    'destinatario_cnpj': cnpj_destinatario,
                    'destinatario_razao': destinatario.get('razao_social', ''),
                    ...
                    'vbc_ipi': item.get('vbc_ipi', 0.0),
                    'pipi': item.get('pipi', 0.0),
                    'vipi': item.get('vipi', 0.0),
